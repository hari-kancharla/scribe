...
struct ModeView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            AppScreenHeader(
                title: "Modes",
                subtitle: "Presets that switch automatically with the app you are in.",
                infoMessage: "Modes help you set up Scribe for different writing tasks, workflows, and scenarios."
            ) {
                headerControls
            }
                                ...
                                VStack(spacing: 24) {
                                    ...
                                    VStack(spacing: 16) {
                                        ...
                                        VStack(spacing: 8) {
                                            ...
                                            Text(
                                                "Set how Scribe transcribes and formats your speech, then start dictating in any app."
                                            )
                                            .font(.system(size: 14))
