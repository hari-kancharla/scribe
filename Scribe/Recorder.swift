...
class Recorder: NSObject, ObservableObject {
    ...
    let logger = Logger(subsystem: "com.personal.scribe", category: "Recorder")
    ...
    let audioSetupQueue = DispatchQueue(label: "com.personal.scribe.audioSetup", qos: .userInitiated)
