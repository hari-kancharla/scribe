...
struct ModelManagementView: View {
    ...
    private var headerSection: some View {
        AppScreenHeader(title: "Model Catalog", subtitle: "Choose how Scribe turns your voice into text.") {
            settingsButton
        }
    }
    ...
    private var localModelsSection: some View {
        VStack(spacing: 12) {
            // Only advertise the refine model when there is somewhere to download it from.
            if !ScribeRefineService.repositoryID.isEmpty {
    ...
    private func confirmDeleteScribeRefineModel() {
        alertTitle = String(localized: "Delete Scribe Refine?")
        alertMessage = String(
