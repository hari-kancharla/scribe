...
struct SettingsView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            AppScreenHeader(
                title: "Settings",
                subtitle: "Shortcuts, pasting, interface and data."
            )
    ...
    private var settingsForm: some View {
        Form {
            ...
            Section("Pasting") {
                ExpandableSettingsRow(
                    ...
                    infoMessage:
                        "Scribe temporarily uses the clipboard to paste transcription. When enabled, it restores your previous clipboard content after the selected delay. When disabled, the pasted transcription stays on your clipboard."
                ) {
        ...
        .alert("Restart Scribe to Apply Language", isPresented: $showLanguageRestartAlert) {
            Button("OK", role: .cancel) {}
        } message: {
            Text("Your language change will take full effect after you quit and reopen Scribe.")
        }
    }
