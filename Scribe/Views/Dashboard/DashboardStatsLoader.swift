        ...
        let task = Task.detached(priority: .utility) {
            ...
            while offset < count {
                ...
                for metric in records {
                    ...
                    let metricDayStart = calendar.startOfDay(for: metric.timestamp)
                    wordsPerDay[metricDayStart, default: 0] += metric.wordCount
                    sessionsPerDay[metricDayStart, default: 0] += 1
            ...
            return DashboardStatsSummary(
                ...
                activeDayCount: streaks.activeDayCount,
                hasSessionToday: streaks.hasSessionToday,
                dailyActivity: streaks.dailyActivity
            )
        }
