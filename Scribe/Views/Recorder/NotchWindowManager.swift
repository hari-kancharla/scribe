...
class NotchWindowManager {
    ...
    private let logger = Logger(subsystem: "com.personal.scribe", category: "NotchWindowManager")
    ...
    /// `orderFrontRegardless()`, and only relaunching Scribe brought the recorder back.
