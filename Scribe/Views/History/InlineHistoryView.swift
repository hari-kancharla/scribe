...
struct InlineHistoryView: View {
    ...
    private let exportService = ScribeCSVExportService()
    ...
    private var topBar: some View {
        ...
        .padding(.vertical, 10)
        // Match the grouped Form below so the search field and the rows share one column.
        .frame(maxWidth: AppScreenMetrics.maxContentWidth)
