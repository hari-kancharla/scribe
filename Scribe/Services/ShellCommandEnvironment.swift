...
enum ShellCommandEnvironment {
    private static let shellPathQueue = DispatchQueue(label: "com.personal.scribe.shell.path")
    ...
    private static let pathDiscoveryCommand =
        "echo __SCRIBE_PATH_START__; print -r -- $PATH; echo __SCRIBE_PATH_END__"
    ...
    private static func discoverPATHFromShell(arguments: [String]) -> String? {
        ...
        let startMarker = "__SCRIBE_PATH_START__"
        let endMarker = "__SCRIBE_PATH_END__"
