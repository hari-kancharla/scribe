...
final class KeychainService {
    ...
    private let logger = Logger(subsystem: "com.personal.scribe", category: "KeychainService")
    #if LOCAL_BUILD
        private let service = "com.personal.scribe.Local"
        private let defaults = UserDefaults.standard
        private let legacyLocalPrefix = "LocalKeychain_"
    #else
        private let service = "com.personal.scribe"
    #endif
