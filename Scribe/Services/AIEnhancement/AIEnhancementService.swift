...
class AIEnhancementService: ObservableObject {
    private let logger = Logger(subsystem: "com.personal.scribe", category: "AIEnhancementService")
    ...
    func repairModePromptSelections() {
        ...
        for index in updatedConfigurations.indices {
            if updatedConfigurations[index].selectedAIProvider == AIProvider.scribeRefine.rawValue {
