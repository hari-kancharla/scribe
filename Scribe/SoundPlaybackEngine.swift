...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.personal.scribe.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.personal.scribe", category: "SoundPlaybackEngine")
