    ...
    func prepare(
        ...
        do {
            ...
            reply(
                makeScribeRefineXPCError(
                    .invalidRequest,
                    description: "Scribe Refine received an invalid prepare request."
                )
            )
            return
        }
        ...
        guard didStart else {
            reply(
                makeScribeRefineXPCError(
                    .connectionFailed,
                    description: "Scribe Refine is shutting down."
                )
            )
            return
        }
    ...
    func enhance(
        ...
        do {
            ...
            reply(
                ...
                makeScribeRefineXPCError(
                    .invalidRequest,
                    description: "Scribe Refine received an invalid enhancement request."
                )
            )
            return
        }
